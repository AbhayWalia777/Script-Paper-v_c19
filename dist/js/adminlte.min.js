...
$(function () {
    ...
    var link    = $('<a />', { href: '' })
      .html(' Hi  Your Subscription is going to expire soon in '+ localStorage.getItem('ExpirationDate') + ' days. We request you to please renew to avoid any inconvenience. Contact administrator')
      .css(link_css)
      .hover(function () {
    ...
    var linkForex = $('<a />', { href: '' })
        .html(' Hi, Your ForexAPI is going to expire soon in ' + localStorage.getItem('ExpiredDate') + ' days. We request you to please renew to avoid any inconvenience.')
        .css(link_css)
        .hover(function () {
            $(this).css(link_hover_css)
        }, function () {
    ...
    if (ForexExpieryDay < Notifydays) {
        wrapper.append(close)
        wrapper.append(linkForex)
        //wrapper.append(btn)
