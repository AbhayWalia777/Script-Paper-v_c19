        ...
        null != M
            ? ((M = JSON.parse(M)),
                ...
                ("MARKET" == M.PRICE_TYPE
                    ...
                    : "Limit" == M.PRICE_TYPE
                        ? $("#rbtnLimit").prop("checked", !0)
                        : "SL" == M.PRICE_TYPE
                            ? $("#rbtnSL").prop("checked", !0)
                            : "SL-M" == M.PRICE_TYPE && $("#rbtnSLM").prop("checked", !0)),
                (b = $("input[Name=MarketType]:checked").val()))
            : ($("#rbtnMarket").prop("checked", !0), $("#rbtnNrml").prop("checked", !0));
    }
    null != b &&
        "" != b &&
        ("Limit" == b
            ? ($("#buySellModel #price").removeAttr("disabled"),
                ...
                $("#rbtnLimit").prop("checked", !0))
            : "SL" == b
                ? ($("#rbtnSL").prop("checked", !0), $("#buySellModel #price").removeAttr("disabled"), $("#buySellModel #price").removeAttr("readonly"), $("#buySellModel #price").val(i), $("#buySellModel #TriggerPrice").removeAttr("disabled"))
                : "SL-M" == b
                    ? ($("#rbtnSLM").prop("checked", !0), $("#buySellModel #price").val(i), $("#buySellModel #price").attr("readonly", "readonly"), $("#buySellModel #price").attr("disabled", "disabled"))
                    : "MARKET" == b &&
                    ($("#rbtnMarket").prop("checked", !0),
                        $("#buySellModel #price").val(0),
                        $("#buySellModel #price").attr("disabled", "disabled"),
...
function ProceedBuySell() {
    ...
    r > 0 &&
        ...
        $.ajax({
            ...
            success: function (e) {
                var t = JSON.parse(e);
                return t.IsError ? (HidePopUp(), toastr.error(t.TypeName), !1) : ("0" != T ? toastr.success("Order Updated successfully") : toastr.success("Order Placed successfully"), !1);
            },
        }),
        HidePopUp(),
        $("#btnProceedBuySell").removeAttr("disabled");
