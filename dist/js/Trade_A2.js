...
function initSocket() {
    socket = new WebSocket("wss://support.Sanaitatechnologies.com/ws");
...
function SetResult(e, t) {
    ...
    if (null != r) {
        ...
        var request = $.ajax({
            ...
            success: function (data) {
                $("#WalletBalance").text(data.amount);
                $("#ActiveWalletBalance").text(parseFloat(data.amount).toFixed(2) + parseFloat(r.TotalActiveTradeProfitOrLoss).toFixed(2));
            }
        });
