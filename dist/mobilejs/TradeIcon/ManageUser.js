            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, coupon) {
                        ...
                        htmldata = htmldata + '<tr><td><button type="button">Apply</button></td><td>' + coupon.Coupon + '</td><td>' + coupon.UserAccountExpiry + '</td><td>' + CouponType + '</td></tr>';
                    });
                    $('#coupons-modal').find('table tbody').html(htmldata);
