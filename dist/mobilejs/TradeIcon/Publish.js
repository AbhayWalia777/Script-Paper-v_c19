            ...
            for (var i = 0; i < tableorb.rows.length; i++) {
                ...
                //}
                    ...
                    if (fTgt2 > 0 && fTgt2Lot == 0) {
                        toastr.error('TGT2 Lot required');
                        return false;
                    }
                }
                    ...
                    if (fTgt3 > 0 && fTgt3Lot == 0) {
                        toastr.error('TGT3 Lot required');
                        return false;
                    }
                }
                    ...
                    toastr.error('SL count required');
                    return false;
                }
            }
