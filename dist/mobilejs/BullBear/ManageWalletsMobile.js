...
/*        $('.select2').select2();*/
    ...
    function SetWalletTransactionDetails(item) {
        ...
        var html =
            ...
            '   <div class="row">' +
            '<div class="col-xs-12 col-sm-12">' +
            '   <p class="watchlist-p" style="font-size: 14px; margin-bottom: 5px;margin: 0;">' + item.Description + '</p>' +
            '</div>' +
            '<div class="col-xs-12" >' +
            '  <p class="watchlist-p" style="font-size: 13px;  margin-bottom: 7px;margin-top:7px;margin: 0;"> | DATE: ' + item.Date_Time_string + ' | AMOUNT: ' + balance.toFixed(2) + '</p>' +
            '  <p class="watchlist-p" style="font-size: 13px;  margin-bottom: 7px;margin-top:7px;margin: 0;"> </p>' +
            '</div>' +
            '        </div>' +
            '     </div>' +
            '  </div>' +
